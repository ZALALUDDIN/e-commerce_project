                    ...
                    <table class="table table-hover">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td><label class="badge badge-danger text-info">Pending</label></td>
                        </tr>
                        <tr>
                          <td>Kamal</td>
                          <td>Ocean Fish</td>
                          <td class="text-danger"> 21.06% <i class="ti-arrow-down"></i></td>
                          <td><label class="badge badge-warning text-info">In progress</label></td>
                        </tr>
                        <tr>
                          <td>Jamal</td>
                          <td>Fast Food</td>
                          <td class="text-danger"> 35.00% <i class="ti-arrow-down"></i></td>
                          <td><label class="badge badge-info text-info">Fixed</label></td>
                        </tr>
                        <tr>
                          <td>Maham</td>
                          <td>Papaya & Crips</td>
                          <td class="text-success"> 82.00% <i class="ti-arrow-up"></i></td>
                          <td><label class="badge badge-success text-info">Completed</label></td>
                        </tr>
                        <tr>
                          <td>Fahim</td>
                          <td>Oatmell</td>
                        ...
                        <div class="col-md-6 col-xl-7">
                          <div class="table-responsive mb-3 mb-md-0">
                            <table class="table table-borderless report-table">
                              <tr>
                                <td class="text-muted">Chattogram</td>
                                <td class="w-100 px-0">
                              ...
                              <tr>
                                <td class="text-muted">Barisal</td>
                                <td class="w-100 px-0">
                                  <div class="progress progress-md mx-4">
                              ...
                              <tr>
                                <td class="text-muted">Rangpur</td>
                                <td class="w-100 px-0">
                                  <div class="progress progress-md mx-4">
