      ...
      <div class="main-panel">        
        ...
        <footer class="footer">
          <div class="d-sm-flex justify-content-center justify-content-sm-between">
            <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Copyright © <a href="index.php/" target="_blank">E-Commerce Website</a>2021</span>
            <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center">Only the best <a href="index.php/" target="_blank"> E-Commerce Dashboard </a> templates</span>
          </div>
        </footer>
        <!-- partial -->
      </div>
