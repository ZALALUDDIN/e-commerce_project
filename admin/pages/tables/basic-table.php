      ...
      <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
          <a class="navbar-brand brand-logo me-5" href="../../index.php"
            ><img src="../../images/logo.svg" class="me-2" alt="logo"
          /></a>
          ...
          <footer class="footer">
            <div class="d-sm-flex justify-content-center justify-content-sm-between">
              <span class="text-muted text-center text-sm-left d-block d-sm-inline-block"
                >Copyright © <a href="index.php/" target="_blank">E-Commerce Website </a>2021</span
              >
              <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center"
                >Only the best
                <a href="index.php/" target="_blank"> E-Commerce Dashboard </a> </span
              >
            </div>
          </footer>
          <!-- partial -->
