<?php
    class crud{
        ...
        public function common_create($table,$data){
            ...
            $return=array("query"=>$sql,"msg"=>$msg,"error"=>$error,"insert_id"=>$insert_id);
            return $return;
        }
        ...
        public function common_count($table,$data="*",$where=false){
            /* init return value */
            $error=$msg=false;
            $numrows=0;
            ...
            $return=array("msg"=>$msg,"error"=>$error,"numrows"=>$numrows);
            return $return;
        }
    }
